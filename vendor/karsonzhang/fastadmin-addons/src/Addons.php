...
abstract class Addons
{
    ...
    final public function getInfo($name = '')
    {
        ...
        if (\think\facade\Config::has($name, $this->infoRange)) {
            return \think\facade\Config::get($name, $this->infoRange);
        }
    ...
    final public function getConfig($name = '')
    {
        ...
        if (\think\facade\Config::has($name, $this->configRange)) {
            return \think\facade\Config::get($name, $this->configRange);
        }
        $config = [];
        ...
        \think\facade\Config::set($name, $config, $this->configRange);
