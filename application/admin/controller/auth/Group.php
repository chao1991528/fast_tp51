...
class Group extends Backend
{
    ...
    public function initialize()
    {
        ...
        $groupList = Collection::make(AuthGroup::where('id', 'in', $this->childrenGroupIds)->select())->toArray();
    ...
    public function roletree()
    {
        ...
        {
            $id = $id ? $id : NULL;
            $ruleList = Collection::make(model('AuthRule')->order('weigh', 'desc')->select())->toArray();
            //读取父类角色所有节点列表
            $parentRuleList = [];
